...
All errors will be returned as an XML document as specified in the [XML API Error Document](/api/versions/api-4.1/api-errors). When possible the text part of the message will be translated into the users configured language.
...
* [XML Documentation](/api/versions/api-4.1/xml-methods) page.
