...
```URL
http://localhost/ampache/server/xml.server.php?action=handshake&auth=PASSPHRASE&timestamp=TIME&version=500001&user=USER
```
...
* get_indexes
* [advanced_search](/api/versions/api-5.0/api-advanced-search)
* artists
* artist
* artist_songs
* artist_albums
