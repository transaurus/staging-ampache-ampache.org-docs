...
```URL
http://localhost/ampache/server/xml.server.php?action=handshake&auth=PASSPHRASE&timestamp=TIME&version=430001&user=USER
```
...
```URL
http://localhost/ampache/server/xml.server.php?action=handshake&auth=API_KEY&version=430001
```
...
* [XML Documentation (4.3.0)](/api/versions/api-4.3/api-xml-methods)
* [JSON Documentation (4.3.0)](/api/versions/api-4.3/api-json-methods)
...
* songs
* song
* [advanced_search](/api/versions/api-4.3/api-advanced-search)
* stats
* playlists
* playlist
* playlist_songs
