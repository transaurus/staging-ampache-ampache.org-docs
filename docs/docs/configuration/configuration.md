...
metaTitle: "Basic Configuration"
description: "Ampache Basic Configuration"
---
...
Check out the [plugins](/docs/plugins) page for details about all our current plugins and options.
